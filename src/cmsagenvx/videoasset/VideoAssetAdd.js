        ...
        <Container fluid={true}>
          ...
          <Row>
            <Col lg={12}>
              <Card>
              <CardBody>
                    <CardTitle className="h4">Create Video Asset</CardTitle>
                    ...
                    <Row>
                      ...
                      <Col lg={4}>
                        <div className="mb-3">
                          <Label htmlFor="formrow-InputCity">year</Label>
                          <FormGroup tag="fieldset">
        <FormGroup check>
          <Label check>
            <Input type="radio" name="year" value="2021" onChange={handleChange}/> 2021
          </Label>
        </FormGroup>
        <FormGroup check>
          <Label check>
            <Input type="radio" name="year" value="2022" onChange={handleChange}/> 2022
          </Label>
        </FormGroup>
      </FormGroup>
                        </div>
